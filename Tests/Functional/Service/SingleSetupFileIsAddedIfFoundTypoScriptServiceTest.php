...
final class SingleSetupFileIsAddedIfFoundTypoScriptServiceTest extends AbstractTypoScriptServiceTestCase
{
    protected function getFixtureExtensionFolderName(): string
    {
        return 'SingleSetupFileIsAddedIfFound';
    }

    protected function getFixtureExtensionName(): string
    {
        return 'single_setup_file_is_added_if_found';
    }
    ...
    public function filesAreLoaded(): void
    {
        ...
        $this->makeSureNoSetupIs([
            'single_setup_file_is_added_if_found/Configuration/TypoScript/PageSpecific/100/Setup.typoscript',
        ]);
    }
}
