...
final class SingleConstantFileIsAddedIfFoundTypoScriptServiceTest extends AbstractTypoScriptServiceTestCase
{
    protected function getFixtureExtensionFolderName(): string
    {
        return 'SingleConstantFileIsAddedIfFound';
    }

    protected function getFixtureExtensionName(): string
    {
        return 'single_constant_file_is_added_if_found';
    }
    ...
    public function filesAreLoaded(): void
    {
        $this->makeSureConstantsAre([
            'single_constant_file_is_added_if_found/Configuration/TypoScript/PageSpecific/100/Constants.typoscript',
        ]);
